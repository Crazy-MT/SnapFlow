...
extension SnapFlowKit.Shortcut {
	/// System-defined keyboard shortcuts.
	static var system: [Self] { CarbonSnapFlowKit.system }
...
private var keyToCharacterMapping: [SnapFlowKit.Key: String] = [
	.return: "↩",
	.delete: "⌫",
	.deleteForward: "⌦",
	.end: "↘",
...
private var keyToKeyEquivalentString: [SnapFlowKit.Key: String] = [
...
extension SnapFlowKit.Shortcut: CustomStringConvertible {
	/**
